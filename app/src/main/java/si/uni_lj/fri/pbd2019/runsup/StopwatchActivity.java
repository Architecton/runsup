...
public class StopwatchActivity extends AppCompatActivity {
    ...
    Button stopwatchStartButton = findViewById(R.id.button_stopwatch_start);
    Button endWorkoutButton = findViewById(R.id.button_stopwatch_endworkout);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        positions = new ArrayList<>();  // initialize list of positions lists.
        ...
        Button ctrlButton = findViewById(R.id.button_stopwatch_start);  // TODO
        Button stopWorkoutButton = findViewById(R.id.button_stopwatch_endworkout); // TODO
    ...
    public void startStopwatch(final View view) {
        ...
        updateStartButtonText(Constant.STATE_RUNNING);
    ...
    public void pauseStopwatch(View view) {
        ...
        updateStartButtonText(Constant.STATE_PAUSED);
    ...
    private void updateStartButtonText(int state) {
        Button startButton = findViewById(R.id.button_stopwatch_start);

        switch(state) {
            case Constant.STATE_RUNNING:
                startButton.setText("Pause Workout");
                break;
            case Constant.STATE_PAUSED:
                startButton.setText("Continue Workout");
                break;
